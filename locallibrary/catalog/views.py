...
def index(request):
    ...
    num_books_containing_letter = Book.objects.filter(title__icontains=letter).count()
    ...
    return render(
        ...
        context={'num_books':num_books,'num_instances':num_instances,'num_instances_available':num_instances_available,'num_authors':num_authors,'num_genres':num_genres,
                 'letter':letter, 'num_books_containing_letter':num_books_containing_letter, 'num_visits':num_visits},
    )
...
class AuthorDetalView(generic.DetailView):
    model = Author
